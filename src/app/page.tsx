...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col relative overflow-hidden font-inter">
      ...
      {/* Background Beams with Collision Wrapper */}
          ...
          <div className="text-center space-y-8 px-4">
            ...
            >
              ...
              <HoverBorderGradient
                ...
                as="button"
                className="bg-black/50 backdrop-blur-sm text-white flex items-center space-x-2 px-6 py-2" // Adjusted padding for button
