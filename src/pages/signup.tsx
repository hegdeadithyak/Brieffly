  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-900 bg-grid-small-white/[0.2] relative overflow-hidden font-sans">
      ...
      >
        ...
        >
          {userExists ? 'Looks like you already have an account. Please log in.' : 'Sign up to get started with Brieffly'}
        </motion.p>
        ...
        >
          ...
          >
            <Link href="/" className="text-blue-400 hover:text-blue-300 text-lg">
              {userExists ? 'Need a new account? Sign up' : 'Already have an account? Log in'}
            </Link>
          </motion.div>
        </motion.form>
      </motion.div>
