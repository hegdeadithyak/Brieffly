  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col relative overflow-hidden font-inter ">
      ...
      >
        ...
        >
          Empowering students with real-time test experiences to boost
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          >
            ...
            <p className="text-neutral-400">
              At Brieffly, we're dedicated to revolutionizing the way students
              prepare for exams. By providing an authentic test environment, we
              aim to reduce exam anxiety and improve overall performance.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-neutral-400">
              Our platform simulates real exam conditions, allowing students to
              practice under time pressure, adapt to various question types, and
              receive instant feedback on their performance.
            </p>
          </motion.div>
        </div>

        <h2 className="text-3xl font-bold text-center text-neutral-200 mb-8">
          Key Features
        </h2>
          ...
          {[
            {
              ...
              description:
                "Experience the pressure of timed exams to improve your time management skills.",
            },
            {
              icon: BookOpen,
              title: "Diverse Question Banks",
              description:
                "Access a wide range of questions across various subjects and difficulty levels.",
            },
            {
              icon: Brain,
